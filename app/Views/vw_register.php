...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5"><img src="<?= base_url('img/icon.png') ?>" width="50px" height="50px">Register Form</h1>
            ...
            <form method="post" action="<?= base_url(); ?>/register/process">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" style="text-transform: lowercase;" id="username" name="username">
                </div>
                <div class="mb-3">
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container">
            <span class="text-muted"> &copy; MyGallery <?php echo date('Y');  ?></span>
        </div>
    </footer>
